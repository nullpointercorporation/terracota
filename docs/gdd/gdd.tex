...
\subsection{como e aonde o jogador começa o jogo}

\subsection{quais os cenários do jogo e como eles se interrelacionam}

\subsection{como o jogador se move de um cenário para o outro}

\subsection{qual é o final do jogo}

\subsection{o que o jogador deve fazer ou onde deve chegar para alcançar o final do jogo}
